        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyholderId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Policies_AspNetUsers_PolicyholderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyCategories", x => x.PolicyCategoryId);
                    table.ForeignKey(
                        name: "FK_PolicyCategories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdjusterId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Claims", x => x.ClaimId);
                    table.ForeignKey(
                        name: "FK_Claims_AspNetUsers_AdjusterId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "719549ef-ce33-4cff-9fa5-90e9c4f80496", "1", "ADMIN", "ADMIN" },
                    { "8b51d34f-7c69-4248-b2d4-9498833546dc", "3", "CLAIM_ADJUSTER", "CLAIM_ADJUSTER" },
                    { "b08c5251-1b4c-467b-a7e8-3773db87efa2", "4", "POLICYHOLDER", "POLICYHOLDER" },
                    { "f94a9635-d906-4dd8-85d0-c41be16bce00", "2", "AGENT", "AGENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyCategories_UserId",
